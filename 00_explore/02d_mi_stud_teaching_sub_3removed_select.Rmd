---
title: "Measurement invariance (MI): Pupil perspective on selected teaching-related constructs (selected 5 countries)"
author: "Stef Meliss"
date: "`r Sys.Date()`"
...
for (v in 1:length(vars)) {
  ...
  # add to summary
  if (!grepl("DISRUPR_|TESUP_|DISCOURSE_", vars[v])) {
