...
for (v in 1:length(vars)) {
  ...
  # fit CFA
  fit <-lavaan::cfa(model, ordered = T, missing = "pairwise", data = stud) 
  ...
  for (c in 1:length(countries)) {
    ...
    tmp_fit <-lavaan::cfa(model, ordered = T, missing = "pairwise", data = stud[stud$COUNTRY == countries[c], ])
  ...
  config <- lavaan::cfa(model, ordered = T, missing = "pairwise", data = stud, group = "COUNTRY")
  ...
  metric <-lavaan::cfa(model, ordered = T, missing = "pairwise", data = stud, group = "COUNTRY", group.equal = c("loadings"))
  scalar <-lavaan::cfa(model, ordered = T, missing = "pairwise", data = stud, group = "COUNTRY", group.equal = c("loadings", "intercepts"))
