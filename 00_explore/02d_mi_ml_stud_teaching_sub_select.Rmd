---
title: "Measurement invariance (MI): Pupil perspective on selected teaching-related constructs (6 countries)"
author: "Stef Meliss"
date: "`r Sys.Date()`"
...
stud <- subset(stud, stud$COUNTRY != "Shanghai")
...
**Data from Shanghai and Madrid was removed.**  
