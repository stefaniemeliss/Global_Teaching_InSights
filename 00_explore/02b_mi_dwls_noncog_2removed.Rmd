---
title: "Measurement invariance (MI): Non-cognitive Student Outcomes [2 COUNTRIES REMOVED]"
author: "Stef Meliss"
date: "`r Sys.Date()`"
...
Based on the result that measurement invariance did not hold when using data from all 8 countries or from only 7 countries, here the results are presented when systematically removing two countries at a time.  
...
for (c in 1:ncol(combis)) {
  ...
  stud <- subset(all_data, all_data$COUNTRY != paste(countries, collapse = "|"))
