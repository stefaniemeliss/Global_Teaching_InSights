...
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "idvars.txt"), sep = ";", header = F)
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "adminvars.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "student_file_variables.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_quest.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
...
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_tl.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_otl.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_vcomp.txt"), header = T)
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_vind.txt"), header = T, sep = " ")
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "teacher_file_variables_acomp.txt"))
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.table(file.path(dir, "misc", "teacher_file_variables_vdomain3.txt"), header = T)
...
# read in data dict
tmp <- read.table(file.path(dir, "misc", "teacher_file_variables_vdomain6.txt"), header = T)
...
```{r, echo = F, results='asis'}
# read in data dict
tmp <- read.delim(file.path(dir, "misc", "school_file_variables.txt"), sep = ";", header = F)
names(tmp) <- c("Variable", "Notes")
